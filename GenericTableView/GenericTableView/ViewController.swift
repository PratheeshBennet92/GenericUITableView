...
class ViewController: UIViewController {
  ...
  private func addListGrid() {
    ...
    listView.view.topAnchor.constraint(equalTo: self.view.topAnchor, constant:   Constants.hasTopNotch ? Constants.ListView.listViewTop : Constants.ListView.listViewTop).isActive = true
